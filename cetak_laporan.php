          ...
          <div class="table-responsive22">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php
                  $no = 1;
                    $queryview = mysqli_query($koneksi, "SELECT * FROM cetak_laporan");
                    while ($row = mysqli_fetch_assoc($queryview)) {
                      
                  ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $row['nama_spt'];?></td>
                    <td><?php echo $row['nip_spt'];?></td>
                    <td><?php echo $row['pangkat_spt'];?></td>
                    <td><?php echo $row['jabatan_spt'];?></td>
                    <td>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <h4 align="center" >Apakah anda yakin ingin menghapus <?php echo $row['nama_spt'];?><strong><span class="grt"></span></strong> ?</h4>
                              </div>
                              <div class="modal-footer">
                                <button id="nodelete" type="button" class="btn btn-danger pull-left" data-dismiss="modal">Cancel</button>
                                <a href="function_cetak.php?act=deleteproduk&id_laporan=<?php echo $row['id_laporan']; ?>" class="btn btn-success">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
                              ...
                              <div class="modal-body">
                                <form action="function_cetak.php?act=updateproduk" method="post" role="form">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-sm-8"><input type="hidden" class="form-control select2" name="id_laporan" placeholder="ID laporan" value="<?php echo $row['id_laporan']; ?>"></div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                        <div class="row">
                                          <label class="col-sm-3 control-label text-right">NAMA
                                            ...
                                            <div class="col-sm-8"><select id="id_nama" class="form-control select2" name="nama" placeholder="Search.."value="<?php echo $row['nama_spt']; ?>">
