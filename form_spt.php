              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="cetakform_dinamis.php?id<?php echo $row['id_spt']?>" data="_blank"><button class="btn btn-default btn-xs" data="_blank" ><i class="fa fa-print"></i> Cetak SPT</button></a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <h4 align="center" >Apakah anda yakin ingin menghapus <?php echo $row['no_spt'];?><strong><span class="grt"></span></strong> ?</h4>
                              </div>
                              <div class="modal-footer">
                                <button id="nodelete" type="button" class="btn btn-danger pull-left" data-dismiss="modal">Cancel</button>
                                <a href="function_spt.php?act=deleteproduk&id_spt=<?php echo $row['id_spt']; ?>" class="btn btn-success">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
                                ...
                                <form action="function_spt.php?act=updateproduk" method="post" role="form">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <label class="col-sm-3 control-label text-right">Dasar Undangan
                                      <span class="text-red">*</span></label>
                                    <div class="col-sm-8"><input type="text" class="form-control" name="dasar_undangan" placeholder="dasar_undangan" value="<?php echo $row['dasar_undangan']; ?>"></div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
                                    <label class="col-sm-3 control-label text-right">Lokasi
                                      <span class="text-red">*</span></label>
                                    <div class="col-sm-8"><input type="text" class="form-control" name="lokasi" placeholder="lokasi" value="<?php echo $row['lokasi']; ?>"></div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <label class="col-sm-3 control-label text-right">Tanggal SPT
                                      <span class="text-red">*</span></label>
                                    <div class="col-sm-8"><input type="text" class="form-control" name="tgl_spt" placeholder="tgl_spt" value="<?php echo $row['tgl_spt']; ?>"></div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8"><input type="text" class="form-control" name="dasar_undangan" placeholder="" value=""></div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                      <label class="col-sm-3 control-label text-right">Lokasi<span class="text-red">*</span></label>
                      <div class="col-sm-8"><input type="text" class="form-control" name="lokasi" placeholder="" value=""></div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                    ...
                    <div class="form-group">
                      <div class="row">
                      <label class="col-sm-3 control-label text-right">Tanggal SPT<span class="text-red">*</span></label>
                      <div class="col-sm-8"><input type="text" class="form-control" name="tgl_spt" placeholder="" value=""></div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                      <label class="col-sm-3 control-label text-right">Anggaran<span class="text-red">*</span></label>
                      <div class="col-sm-8"><select type="text" class="form-control" name="anggaran" placeholder="" value=""></div>
                    ...
                    <div class="form-group">
                      <div class="row">
                      <label class="col-sm-3 control-label text-right">NIP penandatangan<span class="text-red">*</span></label>
                      <div class="col-sm-8"><input type="text" class="form-control" name="NIP_penandatangan" placeholder="" value=""></div>
                      </div>
                    </div>
                    <div class="modal-footer">
