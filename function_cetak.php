...
//menggunakan if else 
    ...
    if (strpos($selectedanggaran, 'Kegiatan Administrasi Umum Perangkat Daerah Sub Kegiatan Penyelenggaraan Rapat Koordinasi dan Konsultasi SKPD') !== false) {
        ...
        if (strpos($selectedanggaran, 'Kegiatan Administrasi Kepegawaian Perangkat Daerah Sub Kegiatan Pendidikan dan Pelatihan Pegawai Berdasarkan Tugas dan Fungsi') !== false) {
            ...
            $tinggiNama = $pdf->getStringHeight(85, txt: 'Pembebanan anggaran' . "\na. Instansi" . "\n\n\nb. Mata Anggaran");
...
//bidang
     ...
     $pdf->MultiCell(60, 10, 'tanggal', 1, 'C', 0, 0, '', '', true, 0, false, true, 20, 'T');
     $pdf->MultiCell(60, 10, 'Lama Perjalanan Dinas', 1, 'C', 0, 0, '', '', true, 0, false, true, 20, 'T');
     $pdf->MultiCell(40, 10, 'Keterangan', 1, 'C', 0, 0, '', '', true, 0, false, true, 20, 'T');
     ...
     $pdf->SetX(255);
     $pdf->MultiCell(30, 10, 'Keberangkatan Dari Tempat  kedudukan asal', 1, 'C', 0, 0, '', '', true, 0, false, true, 20, 'T');
     $pdf->MultiCell(30, 10, 'Tiba Kembali Kedudukan Asal', 1, 'C', 0, 0, '', '', true, 0, false, true, 20, 'T');   
