...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2024 at 09:55 AM
...
INSERT INTO `form_spt` (`id_spt`, `no_spt`, `dasar_undangan`, `lokasi`, `tgl_kegiatan`, `tgl_pulang`, `tgl_spt`, `anggaran`, `NIP_penandatangan`) VALUES
(8, '', 'Dokumen Pelaksanaan Anggaran (DPA) BPSDMD Provinsi Jawa Tengah Tahun 2024 Nomor 01891/DPA/2024 APBD Tahun 2024 pada Kegiatan Administrasi Umum Perangkat Daerah Sub Kegiatan Dukungan Pelaksanaan Sistem Pemerintahan Berbasis Elektronik pada SKPD;	 ', 'JL. Letjend Suprapto, Ungaran, Kab.Semarang', '5 Juni 2024', '5 Juni 2024', '4 Juni 202', '4', '197305011998011001'),
(12, '', 'Surat Sekretaris Daerah Provinsi Jawa Tengah Nomor 000.8.3/261 Tanggal 29 Mei 2024.Hal Desk Pengisian Aplikasi Metal', 'JL. Letjend Suprapto, Ungaran, Kab.Semarang', '5 Juni 2024', '5 Juni 2024', '4 Juni 2024', '3', '197305011998011001');
...
(24, ' Dokumen Pelaksanaan Anggaran (DPA) BPSDMD Provinsi Jawa Tengah Tahun 2024 Nomor 01891/DPA/2024 APBD Tahun 2024 pada Kegiatan Administrasi Umum Perangkat Daerah Sub Kegiatan Dukungan Pelaksanaan Sistem Pemerintahan Berbasis Elektronik pada SKPD;	', ''),
(25, 'Surat Sekretaris Daerah Provinsi Jawa Tengah Nomor 000.8.3/261 Tanggal 29 Mei 2024.Hal Desk Pengisian Aplikasi Metal', '');
...
--
ALTER TABLE `form_spt`
  MODIFY `id_spt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
